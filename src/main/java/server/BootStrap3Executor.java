 ...
 **/
public class BootStrap3Executor {

    TimeUnit unit = TimeUnit.SECONDS;
    BlockingQueue workQueue = new ArrayBlockingQueue<>(10000);
    private ThreadPoolExecutor poolExecutor = new ThreadPoolExecutor(10, 50, 100, unit, workQueue);
    ...
    public static void main(String[] args) throws Exception {
        ...
        BootStrap3Executor bootStrap = new BootStrap3Executor();
        bootStrap.start();
    }
}
